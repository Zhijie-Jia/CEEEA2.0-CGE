...
$ontext
In DyanamicParameter.gms file, we need to determine the the growth path of TFP,
AEEI and electricity scale, based on the given growth path of GDP, CO2 emissions
and electricity growth. So in this file, we need to extract data from given path
...
* here we use pene for other scnearios benchmark price of energy, to simulate ADEEI. pzbau for PPI calculation. pqbau and Xpbau for CPI calculation.
penebau1(t,j)            =         pene.l(j);
pzbau1(t,j)              =         pz.l(j);
pqbau1(t,j)              =         pq.l(j);
Xpbau1(t,j,l)            =         Xp.l(j,l);
...
if(ord(t)=         1        ,Emissions.fx=BAUemissions("2019");        GDP.fx=BAUGDP("2019");        TOTelectricity.fx=BAUTOTelectricity("2019");        );
if(ord(t)=         2        ,Emissions.fx=BAUemissions("2020");        GDP.fx=BAUGDP("2020");        TOTelectricity.fx=BAUTOTelectricity("2020");        );
if(ord(t)=         3        ,Emissions.fx=BAUemissions("2021");        GDP.fx=BAUGDP("2021");        TOTelectricity.fx=BAUTOTelectricity("2021");        );
if(ord(t)=         4        ,Emissions.fx=BAUemissions("2022");        GDP.fx=BAUGDP("2022");        TOTelectricity.fx=BAUTOTelectricity("2022");        );
if(ord(t)=         5        ,Emissions.fx=BAUemissions("2023");        GDP.fx=BAUGDP("2023");        TOTelectricity.fx=BAUTOTelectricity("2023");        );
if(ord(t)=         6        ,Emissions.fx=BAUemissions("2024");        GDP.fx=BAUGDP("2024");        TOTelectricity.fx=BAUTOTelectricity("2024");        );
if(ord(t)=         7        ,Emissions.fx=BAUemissions("2025");        GDP.fx=BAUGDP("2025");        TOTelectricity.fx=BAUTOTelectricity("2025");        );
if(ord(t)=         8        ,Emissions.fx=BAUemissions("2026");        GDP.fx=BAUGDP("2026");        TOTelectricity.fx=BAUTOTelectricity("2026");        );
if(ord(t)=         9        ,Emissions.fx=BAUemissions("2027");        GDP.fx=BAUGDP("2027");        TOTelectricity.fx=BAUTOTelectricity("2027");        );
if(ord(t)=        10        ,Emissions.fx=BAUemissions("2028");        GDP.fx=BAUGDP("2028");        TOTelectricity.fx=BAUTOTelectricity("2028");        );
if(ord(t)=        11        ,Emissions.fx=BAUemissions("2029");        GDP.fx=BAUGDP("2029");        TOTelectricity.fx=BAUTOTelectricity("2029");        );
if(ord(t)=        12        ,Emissions.fx=BAUemissions("2030");        GDP.fx=BAUGDP("2030");        TOTelectricity.fx=BAUTOTelectricity("2030");        );
if(ord(t)=        13        ,Emissions.fx=BAUemissions("2031");        GDP.fx=BAUGDP("2031");        TOTelectricity.fx=BAUTOTelectricity("2031");        );
if(ord(t)=        14        ,Emissions.fx=BAUemissions("2032");        GDP.fx=BAUGDP("2032");        TOTelectricity.fx=BAUTOTelectricity("2032");        );
if(ord(t)=        15        ,Emissions.fx=BAUemissions("2033");        GDP.fx=BAUGDP("2033");        TOTelectricity.fx=BAUTOTelectricity("2033");        );
if(ord(t)=        16        ,Emissions.fx=BAUemissions("2034");        GDP.fx=BAUGDP("2034");        TOTelectricity.fx=BAUTOTelectricity("2034");        );
if(ord(t)=        17        ,Emissions.fx=BAUemissions("2035");        GDP.fx=BAUGDP("2035");        TOTelectricity.fx=BAUTOTelectricity("2035");        );
if(ord(t)=        18        ,Emissions.fx=BAUemissions("2036");        GDP.fx=BAUGDP("2036");        TOTelectricity.fx=BAUTOTelectricity("2036");        );
if(ord(t)=        19        ,Emissions.fx=BAUemissions("2037");        GDP.fx=BAUGDP("2037");        TOTelectricity.fx=BAUTOTelectricity("2037");        );
if(ord(t)=        20        ,Emissions.fx=BAUemissions("2038");        GDP.fx=BAUGDP("2038");        TOTelectricity.fx=BAUTOTelectricity("2038");        );
if(ord(t)=        21        ,Emissions.fx=BAUemissions("2039");        GDP.fx=BAUGDP("2039");        TOTelectricity.fx=BAUTOTelectricity("2039");        );
if(ord(t)=        22        ,Emissions.fx=BAUemissions("2040");        GDP.fx=BAUGDP("2040");        TOTelectricity.fx=BAUTOTelectricity("2040");        );
if(ord(t)=        23        ,Emissions.fx=BAUemissions("2041");        GDP.fx=BAUGDP("2041");        TOTelectricity.fx=BAUTOTelectricity("2041");        );
if(ord(t)=        24        ,Emissions.fx=BAUemissions("2042");        GDP.fx=BAUGDP("2042");        TOTelectricity.fx=BAUTOTelectricity("2042");        );
if(ord(t)=        25        ,Emissions.fx=BAUemissions("2043");        GDP.fx=BAUGDP("2043");        TOTelectricity.fx=BAUTOTelectricity("2043");        );
if(ord(t)=        26        ,Emissions.fx=BAUemissions("2044");        GDP.fx=BAUGDP("2044");        TOTelectricity.fx=BAUTOTelectricity("2044");        );
if(ord(t)=        27        ,Emissions.fx=BAUemissions("2045");        GDP.fx=BAUGDP("2045");        TOTelectricity.fx=BAUTOTelectricity("2045");        );
if(ord(t)=        28        ,Emissions.fx=BAUemissions("2046");        GDP.fx=BAUGDP("2046");        TOTelectricity.fx=BAUTOTelectricity("2046");        );
if(ord(t)=        29        ,Emissions.fx=BAUemissions("2047");        GDP.fx=BAUGDP("2047");        TOTelectricity.fx=BAUTOTelectricity("2047");        );
if(ord(t)=        30        ,Emissions.fx=BAUemissions("2048");        GDP.fx=BAUGDP("2048");        TOTelectricity.fx=BAUTOTelectricity("2048");        );
if(ord(t)=        31        ,Emissions.fx=BAUemissions("2049");        GDP.fx=BAUGDP("2049");        TOTelectricity.fx=BAUTOTelectricity("2049");        );
if(ord(t)=        32        ,Emissions.fx=BAUemissions("2050");        GDP.fx=BAUGDP("2050");        TOTelectricity.fx=BAUTOTelectricity("2050");        );
if(ord(t)=        33        ,Emissions.fx=BAUemissions("2051");        GDP.fx=BAUGDP("2051");        TOTelectricity.fx=BAUTOTelectricity("2051");        );
if(ord(t)=        34        ,Emissions.fx=BAUemissions("2052");        GDP.fx=BAUGDP("2052");        TOTelectricity.fx=BAUTOTelectricity("2052");        );
if(ord(t)=        35        ,Emissions.fx=BAUemissions("2053");        GDP.fx=BAUGDP("2053");        TOTelectricity.fx=BAUTOTelectricity("2053");        );
if(ord(t)=        36        ,Emissions.fx=BAUemissions("2054");        GDP.fx=BAUGDP("2054");        TOTelectricity.fx=BAUTOTelectricity("2054");        );
if(ord(t)=        37        ,Emissions.fx=BAUemissions("2055");        GDP.fx=BAUGDP("2055");        TOTelectricity.fx=BAUTOTelectricity("2055");        );
if(ord(t)=        38        ,Emissions.fx=BAUemissions("2056");        GDP.fx=BAUGDP("2056");        TOTelectricity.fx=BAUTOTelectricity("2056");        );
if(ord(t)=        39        ,Emissions.fx=BAUemissions("2057");        GDP.fx=BAUGDP("2057");        TOTelectricity.fx=BAUTOTelectricity("2057");        );
if(ord(t)=        40        ,Emissions.fx=BAUemissions("2058");        GDP.fx=BAUGDP("2058");        TOTelectricity.fx=BAUTOTelectricity("2058");        );
if(ord(t)=        41        ,Emissions.fx=BAUemissions("2059");        GDP.fx=BAUGDP("2059");        TOTelectricity.fx=BAUTOTelectricity("2059");        );
if(ord(t)=        42        ,Emissions.fx=BAUemissions("2060");        GDP.fx=BAUGDP("2060");        TOTelectricity.fx=BAUTOTelectricity("2060");        );
